...
class FaceVGGConfig:
    ...
    def __init__(self):
        # 训练参数
        self.BATCH_SIZE = 128                # 批次大小：每次训练时使用的样本数量
        self.EPOCHS = 300                   # 训练轮数：训练的次数
        self.LEARNING_RATE = 0.001          # 学习率：控制模型参数的更新速度
        self.MOMENTUM = 0.95                 # 动量：加速模型训练
        ...
        # Dropout参数
        self.KEEP_PROB = 0.45                # Dropout保留率
        
        # 激活函数
        self.ACTIVATION = 'leaky_relu'            # 可选：'relu'、'leaky_relu'
